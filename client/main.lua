...
AddEventHandler('QBCore:Client:OnPlayerLoaded', function()
    ...
    if PlayerJob and PlayerJob.name ~= "police" or PlayerJob.name ~= "bcso" or PlayerJob.name ~= "ambulance" then
        if DutyBlips then
...
RegisterNetEvent('QBCore:Client:OnJobUpdate', function(JobInfo)
    if JobInfo.name == "police" and PlayerJob.name ~= "police" or JobInfo.name == "bcso" and PlayerJob.name ~= "bcso" or JobInfo.name == "ambulance" and PlayerJob.name ~= "ambulance" then
    ...
    if JobInfo.name ~= "police" or JobInfo.name ~= "bcso" or JobInfo.name ~= "ambulance" then
        if DutyBlips then
            for _, v in pairs(DutyBlips) do
                RemoveBlip(v)
            end
