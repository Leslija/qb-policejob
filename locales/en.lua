local Translations = {
    error = {
        ...
        on_duty_police_only = 'For on-duty pd only',
    ...
    info = {
        ...
        license_type = 'License Type (driver/weapon/business/permit)',
        ...
        bill = 'Bill',
        bill_received = 'You received a bill of $%{bill}',
        amount = 'Amount',
    ...
    menu = {
        ...
        pol_impound = 'PD Impound',
        pol_garage = 'Police Garage',
        pol_armory = 'PD Armory',
    },
    email = {
    ...
    commands = {
        ...
        place_object = 'Place/Delete An Object (PD Only)',
        cuff_player = 'Cuff Player (PD Only)',
        escort = 'Escort Player',
        callsign = 'Give Yourself A Callsign',
        clear_casign = 'Clear Area of Casings (PD Only)',
        jail_player = 'Jail Player (PD Only)',
        unjail_player = 'Unjail Player (PD Only)',
        clearblood = 'Clear The Area of Blood (PD Only)',
        seizecash = 'Seize Cash (PD Only)',
        softcuff = 'Soft Cuff (PD Only)',
        camera = 'View Security Camera (PD Only)',
        flagplate = 'Flag A Plate (PD Only)',
        unflagplate = 'Unflag A Plate (PD Only)',
        plateinfo = 'Run A Plate (PD Only)',
        depot = 'Impound (Gov Only)',
        impound = 'Seize A Vehicle (PD Only)',
        paytow = 'Pay Tow Driver (PD Only)',
        paylawyer = 'Pay Lawyer (Police, Judge Only)',
        anklet = 'Attach Tracking Anklet (PD Only)',
        ankletlocation = 'Get the location of a persons anklet',
        removeanklet = 'Remove Tracking Anklet (PD Only)',
        drivinglicense = 'Seize Drivers License (PD Only)',
        takedna = 'Take a DNA sample from a person (empty evidence bag needed) (PD Only)',
